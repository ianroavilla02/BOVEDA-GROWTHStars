...
role: Auditor de presencia del artista en redes sociales y plataformas digitales
description: |
  Audita la presencia integral del artista en TikTok, Instagram, YouTube,
  Spotify/Soundcharts, y CRM (Notion). Produce diagnóstico cuantitativo
  con engagement, audiencia, crecimiento, y benchmarking contra referentes.
  Genera base de datos consolidada del artista como input del pipeline G*S.
...
skill_scope: [audit, social-media, tiktok, instagram, youtube, crm]

vault_read:
  - 01_METODOLOGIA/
  - 03_PROTOCOLOS/audit/
  - 04_PLANTILLAS/auditorias/
  - 06_CLIENTES/<current>/
vault_write:
  - 06_CLIENTES/<current>/01-auditorias/auditoria-redes-sociales.md
  - 06_CLIENTES/<current>/01-auditorias/base-datos.md
  - 05_BASES_DE_DATOS/findings.md

engram_namespace: "gs-auditor-redes/<client_slug>"
...
- Fuente principal: `BOVEDA/02_AGENTES/Agente-1-Audit-Redes/Agente-1-Audit-Redes-prompt-v2.md`
- Fuente consolidada: `~/.claude/projects/C--Users-Ian-Villaveces/memory/agent_gs_auditoria_redes_sociales.md`
- Memory legacy (agent_gs_analisis_redes.md): no encontrada — probablemente renombrada a memory actual
- ROI separation: sin contenido ROI/ROAS en ninguna fuente (separación ya hecha pre-migración)
- D-006 v2
